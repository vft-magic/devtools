...
function encode(
  ...
  depth = 0,
  seenVueInstance = new Map<any, number>(),
): number {
...
export function stringifyCircularAutoChunks(
...
export function stringifyStrictCircularAutoChunks(
  data: Record<string, unknown>,
  replacer: Replacer | null = null,
  space: number | null = null,
) {
...
export function parseCircularAutoChunks(
  data: unknown[] | string,
  reviver: ((this: any, key: string, value: any) => any) | null = null,
) {
