...
target.__TMAGIC_DEVTOOLS_KIT_PLUGIN_BUFFER__ ??= [];

export const devtoolsPluginBuffer = new Proxy<DevToolsKitPluginBuffer[]>(target.__TMAGIC_DEVTOOLS_KIT_PLUGIN_BUFFER__, {
